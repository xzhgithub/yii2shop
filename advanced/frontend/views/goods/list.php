		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="filter mt10">
				...
				<div class="filter_wrap">
					<dl>
						<dt>品牌：</dt>
						<dd class="cur"><?=Html::a('不限',['goods/list','category_id'=>$category_id])?></dd>

						<?php foreach($brands as $brand):?>
						<?='<dd>'.Html::a($brand->name,['goods/list','brandid'=>$brand->id,'category_id'=>$category_id]).'</dd>'?>
						<?php endforeach;?>
			...
			<div class="goodslist mt10">
				<ul>
					...
					<li>
						<dl>
							<dt><?=Html::a(Html::img($good->logo),['goods/goodsintro','goods_id'=>$good->id])?></dt>
							<dd><?=$good->name?></dt>
