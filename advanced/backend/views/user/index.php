...
<!--        <th>头像</th>-->
    ...
    <tr>
        ...
        <td><?=\yii\bootstrap\Html::a('重置密码',['user/edit','id'=>$model->id],['class'=>'btn btn-warning btn-xs'])?>
            <?=\yii\bootstrap\Html::a('修改信息',['user/update','id'=>$model->id],['class'=>'btn btn-info btn-xs'])?>
